...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-name { font-weight: 700; font-size: 14px; color: #111827; line-height: 1.2; }
        ...
        .nav-item-inner { display: flex; align-items: center; gap: 10px; width: 100%; }

        .nav-icon { width: 18px; height: 18px; color: #6B7280; flex-shrink: 0; }
        .nav-item.active .nav-icon { color: #1D4ED8; }
        ...
        .user-name-sm { font-size: 13px; font-weight: 600; color: #111827; }
        .user-id { font-size: 11px; color: #9CA3AF; }
        .chevron-icon { width: 16px; height: 16px; color: #9CA3AF; }
        ...
        .notif-btn, .settings-btn {
            position: relative; width: 36px; height: 36px;
            display: flex; align-items: center; justify-content: center;
            border-radius: 8px; cursor: pointer; transition: background .15s;
        }
        .notif-btn:hover, .settings-btn:hover { background: #F3F4F6; }
