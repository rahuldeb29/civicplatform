<aside class="admin-sidebar">
    ...
    <div class="admin-logo">
        ...
        <div class="admin-logo-text">
            ...
            <div class="admin-logo-sub">Department Head</div>
        </div>
    </div>
    ...
    <div class="admin-nav-scroll">
        ...
        <a href="{{ route('department.dashboard') }}" class="admin-nav-item">
            Dashboard
        </a>
        ...
        <a href="{{ route('admin.officers.index') }}" class="admin-nav-item">
            Officers
        </a>
