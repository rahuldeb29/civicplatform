...
@section('content')
    ...
    <div class="dashboard-container">
        ...
        <div class="card">
            ...
            <div id="reportMap" style="height:450px;border-radius:12px;">
            </div>
                    ...
                    @forelse($reports as $report)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="badge status-{{ strtolower($report->status) }}">
                            ...
                            <td>
                                ...
                                <a href="{{ route('officers.reports.show', $report->id) }}" class="btn-view">
